...
objLoader.load('/rocks.obj',
   function (rocks_wire) {
      ...
      rocks_wire.position.x = -7.3;
      rocks_wire.position.y = 6;
      rocks_wire.position.z = 45;
      scene.add(rocks_wire);
   }
);

//Broken Sphere
objLoader.load('/broken_sphere.obj',
...
const sun_texture = new THREE.TextureLoader().load("assets/seamless_tex.png");
sun_texture.wrapS = THREE.RepeatWrapping;
sun_texture.wrapT = THREE.RepeatWrapping;
sun_texture.repeat.set(2, 2);

const sun_texture2 = new THREE.TextureLoader().load("assets/seamless_tex.png");
sun_texture2.wrapS = THREE.RepeatWrapping;
sun_texture2.wrapT = THREE.RepeatWrapping;
sun_texture2.repeat.set(5, 5);

const sun_texture3 = new THREE.TextureLoader().load("assets/seamless_tex.png");
sun_texture2.wrapS = THREE.RepeatWrapping;
sun_texture2.wrapT = THREE.RepeatWrapping;
...
const cam_pos2 = new THREE.Mesh(
   new THREE.BoxGeometry(.1, .1, .1),
   new THREE.MeshBasicMaterial({ color: 0xffffff, wireframe: true }));
cam_pos2.position.x = -1.6;
cam_pos2.position.y = 10;
cam_pos2.position.z = 48;
...
const pointLight2 = new THREE.PointLight(0x63e590, 3, 30);
const statueLight = new THREE.SpotLight(0x63e590, 5.5, 1.5, 1, 8);
const statue2Light = new THREE.PointLight(0x63e590, 1, 10.5);
const dirLight = new THREE.DirectionalLight(0xffffff, .3);
pointLight.position.set(0, 13, -44);
pointLight2.position.set(-20.7, 14, 5);
statueLight.position.set(-1.5, 8.5, 29);
statue2Light.position.set(-20.7, 14, 5);
dirLight.position.y = 7;
dirLight.rotation.y = 10;
scene.add(pointLight, pointLight2, dirLight, statueLight, statue2Light);
...
home_btn_m.addEventListener('click', () => {
   currentScene = 0;
   navigatePages(0);
})
...
games_btn_m.addEventListener('click', () => {
   currentScene = 2;
   navigatePages(2);
})
...
art_btn_m.addEventListener('click', () => {
   currentScene = 3;
   navigatePages(3);
})
...
const contact_btn2 = document.getElementById("btn-contact-2");
...
contact_btn_m.addEventListener('click', () => {
   currentScene = 4;
   navigatePages(4);
})
